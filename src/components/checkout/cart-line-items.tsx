...
export function CartLineItems({
  ...
  console.log("CartLineItems - items:", items)
  console.log("CartLineItems - isScrollable:", isScrollable)
  console.log("CartLineItems - isEditable:", isEditable)
  console.log("CartLineItems - variant:", variant)
  ...
  return (
    <Comp className="h-full">
      ...
      >
        {items.map((item) => {
          console.log("CartLineItems - rendering item:", item)
          return (
